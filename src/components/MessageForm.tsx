...
const MessageForm = () => {
  ...
  return (
    <form className="relative mx-auto max-w-3xl rounded-t-xl" onSubmit={handleSubmit}>
      <div className=" border-gray-200 h-[140px] rounded-t-xl backdrop-blur border-t border-l border-r border-gray-500/10 dark:border-gray-50/[0.06] bg-white supports-backdrop-blur:bg-white/95 p-5">
        ...
        <footer><center>Made on <b>FAQCast</b> #4</center></footer>
      </div>
    </form>
  )
}
