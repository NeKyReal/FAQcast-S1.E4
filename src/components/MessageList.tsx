      ...
      {messages?.map((message, i) => {
        ...
        return (
          ...
          >
            {!isUser && (
              <img
                src="https://www.solodev.com/file/132db9f1-8eb9-11ed-b378-0eaef3759f5f/openai-icon.png"
            ...
            {isUser && (
              <img
                src="https://cdn.icon-icons.com/icons2/876/PNG/512/boy-avatar-on-round-button_icon-icons.com_68325.png"
